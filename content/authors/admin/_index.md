...
{style="font-size: 1.2rem; background: #E1ECEE; -webkit-background-clip: text; -webkit-text-fill-color: transparent;"}
...
{style="text-align: justify; background: #FFFFFF; link = #bbdefb; -webkit-background-clip: text; -webkit-text-fill-color: transparent;"}
